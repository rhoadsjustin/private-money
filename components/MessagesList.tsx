...
export const MessagesList = ({ messages, response, isGenerating }: MessagesListProps) => {
        ...
        <View
          ...
          {message.role === 'assistant' && (
            <View style={messagesListStyles.iconContainer}>
              <Ionicons name="cash-outline" width={24} height={24} />
            </View>
          )}
          <Text
            style={[
      ...
      {isGenerating && (
        <View style={messagesListStyles.assistantMessageContainer}>
          ...
          {!response ? (
            ...
            <Text style={messagesListStyles.responseText}>{response.trim()}</Text>
          )}
        </View>
      )}
    </ScrollView>
